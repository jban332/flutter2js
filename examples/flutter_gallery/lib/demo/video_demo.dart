...
import 'dart:async';
import 'package:flutter2js/io.dart';
...
class _FadeAnimationState extends SingleTickerProviderStateMixin<FadeAnimation> {
...
class _VideoDemoState extends SingleTickerProviderStateMixin<VideoDemo> {
