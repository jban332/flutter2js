...
class HtmlParagraphBuilder implements ui.ParagraphBuilder {
  ...
  final _context = new html.CanvasElement().context2D;
  _HtmlTextStyle _textStyle;

  HtmlParagraphBuilder(ui.ParagraphStyle style) : this._paragraphStyle = style {
...
class HtmlParagraph implements ui.Paragraph {
  ...
  HtmlParagraph(this.paragraphStyle, this.boxes);
  ...
  void layout(ui.ParagraphConstraints constraints) {
    ...
    var canvasWidth = 0.0;
    var canvasHeight = paragraphStyle.lineHeight;
    var boxIndex = -1;
