...
abstract class ScrollView extends flur.StatelessUIPluginWidget {
  ...
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildScrollView(context, this);
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(new DiagnosticsProperty<ScrollPhysics>('physics', physics,
        showName: false, defaultValue: null));
    description.add(new FlagProperty('shrinkWrap',
...
class ListView extends BoxScrollView {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildListView(context, this);
  }
}
...
class GridView extends BoxScrollView {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildGridView(context, this);
  }
}
