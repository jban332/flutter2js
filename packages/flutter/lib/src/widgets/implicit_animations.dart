...
abstract class ImplicitlyAnimatedWidget extends StatefulWidget {
  ...
  const ImplicitlyAnimatedWidget(
      {Key key, this.curve: Curves.linear, @required this.duration})
      : super(key: key);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new IntProperty('duration', duration.inMilliseconds, unit: 'ms'));
  }
}
...
abstract class AnimatedWidgetBaseState<T extends ImplicitlyAnimatedWidget>
    extends SingleTickerProviderStateMixin<T> {
  ...
  void _updateCurve() {
    if (widget.curve != null)
      _animation =
          new CurvedAnimation(parent: _controller, curve: widget.curve);
    else
...
class AnimatedContainer extends ImplicitlyAnimatedWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(new DiagnosticsProperty<EdgeInsetsGeometry>(
        'padding', padding,
        defaultValue: null));
    description.add(new DiagnosticsProperty<Decoration>('bg', decoration,
        defaultValue: null));
    description.add(new DiagnosticsProperty<Decoration>(
        'fg', foregroundDecoration,
        defaultValue: null));
    ...
    description.add(new DiagnosticsProperty<EdgeInsetsGeometry>(
        ...
        defaultValue: null));
    description
        .add(new ObjectFlagProperty<Matrix4>.has('transform', transform));
  }
}
...
class _AnimatedContainerState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _alignment = visitor(_alignment, widget.alignment,
        (dynamic value) => new AlignmentGeometryTween(begin: value));
    _padding = visitor(_padding, widget.padding,
        (dynamic value) => new EdgeInsetsGeometryTween(begin: value));
    _decoration = visitor(_decoration, widget.decoration,
        (dynamic value) => new DecorationTween(begin: value));
    ...
    _constraints = visitor(_constraints, widget.constraints,
        (dynamic value) => new BoxConstraintsTween(begin: value));
    _margin = visitor(_margin, widget.margin,
        (dynamic value) => new EdgeInsetsGeometryTween(begin: value));
    _transform = visitor(_transform, widget.transform,
        (dynamic value) => new Matrix4Tween(begin: value));
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description.add(new DiagnosticsProperty<AlignmentGeometryTween>(
        'alignment', _alignment,
        showName: false, defaultValue: null));
    description.add(new DiagnosticsProperty<EdgeInsetsGeometryTween>(
        'padding', _padding,
        defaultValue: null));
    description.add(new DiagnosticsProperty<DecorationTween>('bg', _decoration,
        defaultValue: null));
    description.add(new DiagnosticsProperty<DecorationTween>(
        'fg', _foregroundDecoration,
        defaultValue: null));
    description.add(new DiagnosticsProperty<BoxConstraintsTween>(
    ...
    description.add(new DiagnosticsProperty<EdgeInsetsGeometryTween>(
        ...
        defaultValue: null));
    description
        .add(new ObjectFlagProperty<Matrix4Tween>.has('transform', _transform));
  }
}
...
class _AnimatedPositionedState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _left = visitor(
        _left, widget.left, (dynamic value) => new Tween<double>(begin: value));
    _top = visitor(
        _top, widget.top, (dynamic value) => new Tween<double>(begin: value));
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new ObjectFlagProperty<Tween<double>>.has('bottom', _bottom));
    description.add(new ObjectFlagProperty<Tween<double>>.has('width', _width));
    description
        .add(new ObjectFlagProperty<Tween<double>>.has('height', _height));
  }
}
...
class AnimatedPositionedDirectional extends ImplicitlyAnimatedWidget {
  ...
  _AnimatedPositionedDirectionalState createState() =>
      new _AnimatedPositionedDirectionalState();
...
class _AnimatedPositionedDirectionalState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    _top = visitor(
        _top, widget.top, (dynamic value) => new Tween<double>(begin: value));
    _end = visitor(
        _end, widget.end, (dynamic value) => new Tween<double>(begin: value));
    _bottom = visitor(_bottom, widget.bottom,
        (dynamic value) => new Tween<double>(begin: value));
    _width = visitor(_width, widget.width,
        (dynamic value) => new Tween<double>(begin: value));
...
class _AnimatedOpacityState extends AnimatedWidgetBaseState<AnimatedOpacity> {
  ...
  Widget build(BuildContext context) {
    return new Opacity(
        opacity: _opacity.evaluate(animation), child: widget.child);
  }
}
...
class AnimatedDefaultTextStyle extends ImplicitlyAnimatedWidget {
  ...
  _AnimatedDefaultTextStyleState createState() =>
      new _AnimatedDefaultTextStyleState();
...
class _AnimatedDefaultTextStyleState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _style = visitor(_style, widget.style,
        (dynamic value) => new TextStyleTween(begin: value));
  }
...
class AnimatedPhysicalModel extends ImplicitlyAnimatedWidget {
  ...
  _AnimatedPhysicalModelState createState() =>
      new _AnimatedPhysicalModelState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new DiagnosticsProperty<bool>('animateColor', animateColor));
...
class _AnimatedPhysicalModelState
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _borderRadius = visitor(_borderRadius, widget.borderRadius,
        (dynamic value) => new BorderRadiusTween(begin: value));
    _elevation = visitor(_elevation, widget.elevation,
        (dynamic value) => new Tween<double>(begin: value));
    _color = visitor(
        _color, widget.color, (dynamic value) => new ColorTween(begin: value));
