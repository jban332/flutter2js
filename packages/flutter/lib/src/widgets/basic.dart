...
export 'package:flutter/foundation.dart'
    show ChangeNotifier, Listenable, TargetPlatform, ValueNotifier;
...
class Directionality extends InheritedWidget {
  ...
  @override
  bool updateShouldNotify(Directionality old) =>
...
///    paint time.
class Opacity extends flur.SingleChildUIPluginWidget {
  ...
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildOpacity(context, this);
  }
}
...
class ShaderMask extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildShaderMask(context, this);
  }
}
...
class BackdropFilter extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildBackdropFilter(context, this);
  }
}
...
class CustomPaint extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildCustomPaint(context, this);
  }
}
...
class ClipRect extends flur.SingleChildUIPluginWidget {
  /// Creates a rectangular clip.
  ///
  /// If [clipper] is null, the clip will match the layout size and position of
  /// the child.
  const ClipRect({Key key, this.clipper, Widget child})
      : super(key: key, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description.add(new DiagnosticsProperty<CustomClipper<Rect>>(
        'clipper', clipper,
        defaultValue: null));
  }
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildClipRect(context, this);
  }
}
...
///  * [ClipOval], for an elliptical clip.
///  * [ClipPath], for an arbitrarily shaped clip.
class ClipRRect extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description.add(new DiagnosticsProperty<BorderRadius>(
        'borderRadius', borderRadius,
        showName: false, defaultValue: null));
    description.add(new DiagnosticsProperty<CustomClipper<RRect>>(
        'clipper', clipper,
        defaultValue: null));
  }
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildClipRRect(context, this);
  }
}
...
///  * [ClipRRect], for a clip with rounded corners.
///  * [ClipPath], for an arbitrarily shaped clip.
class ClipOval extends flur.SingleChildUIPluginWidget {
  /// Creates an oval-shaped clip.
  ///
  /// If [clipper] is null, the oval will be inscribed into the layout size and
  /// position of the child.
  const ClipOval({Key key, this.clipper, Widget child})
      : super(key: key, child: child);
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildClipOval(context, this);
  }
}
...
class ClipPath extends flur.SingleChildUIPluginWidget {
  /// Creates a path clip.
  ///
  ...
  /// efficiently.
  const ClipPath({Key key, this.clipper, Widget child})
      : super(key: key, child: child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description.add(new DiagnosticsProperty<CustomClipper<Path>>(
        'clipper', clipper,
        defaultValue: null));
  }
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildClipPath(context, this);
  }
}
...
class PhysicalModel extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(
        new DiagnosticsProperty<BorderRadius>('borderRadius', borderRadius));
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildPhysicalModel(context, this);
  }
}
...
class Transform extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildTransform(context, this);
  }
}
...
///  * [Transform], which applies an arbitrary transform to its child widget at
///    paint time.
class FittedBox extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFittedBox(context, this);
  }
}

/// A widget that applies a translation expressed as a fraction of the box's
/// size before painting its child.
class FractionalTranslation extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFractionalTranslation(context, this);
  }
}
...
class RotatedBox extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildRotatedBox(context, this);
  }
}
...
///    in the parent.
class Padding extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description
        .add(new DiagnosticsProperty<EdgeInsetsGeometry>('padding', padding));
  }

  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildPadding(context, this);
  }
}
...
class Align extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(
        new DoubleProperty('heightFactor', heightFactor, defaultValue: null));
  }

  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildAlign(context, this);
  }
}
...
///    children.
class CustomSingleChildLayout extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildCustomSingleChildLayout(context, this);
  }
}
...
class LayoutId extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildLayoutId(context, this);
  }
}
...
///   matrices.
class CustomMultiChildLayout extends flur.MultiChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildCustomMultiChildLayout(context, this);
  }
}
...
///  * [FittedBox], which sizes and positions its child widget to fit the parent
///    according to a given [BoxFit] discipline.
class SizedBox extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(
        new DoubleProperty('width', width, defaultValue: null, level: level));
    description.add(
        new DoubleProperty('height', height, defaultValue: null, level: level));
  }

  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildSizedBox(context, this);
  }
}
...
///  * [AspectRatio], a widget that attempts to fit within the parent's
///    constraints while also sizing its child to match a given sapect ratio.
class ConstrainedBox extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    super.debugFillProperties(description);
    description.add(new DiagnosticsProperty<BoxConstraints>(
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildConstrainedBox(context, this);
  }
}
...
///   the child according to a [Alignment] value)
/// * [OverflowBox]
class FractionallySizedBox extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFractionallySizedBox(context, this);
  }
}
...
///  * [SizedBox], which lets you specify tight constraints by explicitly
///    specifying the height or width.
class LimitedBox extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildLimitedBox(context, this);
  }
}
...
class OverflowBox extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new DoubleProperty('maxWidth', maxWidth, defaultValue: null));
    description
        .add(new DoubleProperty('minHeight', minHeight, defaultValue: null));
    description
        .add(new DoubleProperty('maxHeight', maxHeight, defaultValue: null));
  }

  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildOverflowBox(context, this);
  }
}

/// A widget that is a specific size but passes its original constraints
/// through to its child, which will probably overflow.
class SizedOverflowBox extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildSizedOverflowBox(context, this);
  }
}
...
/// room in the parent.
class Offstage extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildOffstage(context, this);
  }
}
...
class AspectRatio extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildAspectRatio(context, this);
  }
}
...
/// the tree.
class IntrinsicWidth extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildIntrinsicWidth(context, this);
  }
}
...
/// worst case, this widget can result in a layout that is O(N²) in the depth of
/// the tree.
class IntrinsicHeight extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildIntrinsicHeight(context, this);
  }
}
...
class Baseline extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildBaseline(context, this);
  }
}
...
class SliverToBoxAdapter extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildSliverToBoxAdapter(context, this);
  }
}
...
///
///  * [CustomScrollView], which displays a scrollable list of slivers.
class SliverPadding extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildSliverPadding(context, this);
  }
}
...
///    layout algorithm.
class ListBody extends flur.MultiChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildListBody(context, this);
  }
}
...
///  * [Flow], which provides paint-time control of its children using transform
///    matrices.
class Stack extends flur.MultiChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildStack(context, this);
  }
}
...
class Positioned extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildPositioned(context, this);
  }
}
...
class Flex extends flur.MultiChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(new EnumProperty<CrossAxisAlignment>(
    ...
    description.add(new EnumProperty<TextBaseline>('textBaseline', textBaseline,
        defaultValue: null));
  }

  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFlex(context, this);
  }
}
...
class Flexible extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFlexible(context, this);
  }
}
...
class Wrap extends flur.MultiChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildWrap(context, this);
  }
}
...
///  * [CustomMultiChildLayout], which uses a delegate to position multiple
///    children.
class Flow extends flur.MultiChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildFlow(context, this);
  }
}
...
class RichText extends flur.StatelessUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildRichText(context, this);
  }
}
...
class RawImage extends flur.StatelessUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildRawImage(context, this);
  }
}
...
class Listener extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildListener(context, this);
  }
}
...
class RepaintBoundary extends flur.SingleChildUIPluginWidget {
  ...
  factory RepaintBoundary.wrap(Widget child, int childIndex) {
    ...
    final Key key = child.key != null
        ? new ValueKey<Key>(child.key)
        : new ValueKey<int>(childIndex);
  ...
  static List<RepaintBoundary> wrapAll(List<Widget> widgets) {
    final List<RepaintBoundary> result =
        new List<RepaintBoundary>(widgets.length);
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildRepaintBoundary(context, this);
  }
}
...
class IgnorePointer extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildIgnorePointer(context, this);
  }
}
...
class AbsorbPointer extends flur.SingleChildUIPluginWidget {
  /// Creates a widget that absorbs pointers during hit testing.
  ///
  /// The [absorbing] argument must not be null
  const AbsorbPointer({Key key, this.absorbing: true, Widget child})
      : super(key: key, child: child);
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildAbsorbPointer(context, this);
  }
}
...
class MetaData extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildMetaData(context, this);
  }
}
...
class Semantics extends flur.SingleChildUIPluginWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(
        new DiagnosticsProperty<bool>('checked', checked, defaultValue: null));
    description.add(new DiagnosticsProperty<bool>('selected', selected,
        defaultValue: null));
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildSemantics(context, this);
  }
}
...
/// callbacks.
class MergeSemantics extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildMergeSemantics(context, this);
  }
}
...
class BlockSemantics extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildBlockSemantics(context, this);
  }
}
...
class ExcludeSemantics extends flur.SingleChildUIPluginWidget {
  ...
  @override
  Widget buildWithUIPlugin(BuildContext context, flur.UIPlugin plugin) {
    return plugin.buildExcludeSemantics(context, this);
  }
}
...
class KeyedSubtree extends StatelessWidget {
  ...
  const KeyedSubtree({Key key, @required this.child}) : super(key: key);
