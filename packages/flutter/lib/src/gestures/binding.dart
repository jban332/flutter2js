...
abstract class GestureBindingMixin implements GestureBinding {
  static void doInitInstances(GestureBinding binding) {
    GestureBinding._instance = binding;
    ui.window.onPointerDataPacket = binding._handlePointerDataPacket;
  }

  static void doUnlocked(GestureBinding binding) {
    binding._flushPointerEventQueue();
  }
...
abstract class GestureBinding extends BindingBase
    with HitTestable, HitTestDispatcher, HitTestTarget {
