...
abstract class Path {
  factory Path() {
    return flur.PlatformPlugin.current.newPath();
  }
...
abstract class Canvas {
  ...
  factory Canvas(PictureRecorder recorder, Rect cullRect) {
    ...
    return flur.PlatformPlugin.current.newCanvas(recorder, cullRect);
  }
...
abstract class PictureRecorder {
  ...
  factory PictureRecorder() {
    return flur.PlatformPlugin.current.newPictureRecorder();
  }
