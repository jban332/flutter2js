...
class SemanticsAction {
  ...
  static const SemanticsAction moveCursorForwardByCharacter =
      const SemanticsAction._(_kMoveCursorForwardByCharacter);

  /// Move the cursor backward by one character.
  ///
  /// This is for example used by the cursor control in text fields.
  static const SemanticsAction moveCursorBackwardByCharacter =
      const SemanticsAction._(_kMoveCursorBackwardByCharacter);
...
abstract class SemanticsUpdateBuilder {
  ...
  factory SemanticsUpdateBuilder() =>
      flutter2js.PlatformPlugin.current.newSemanticsUpdateBuilder();
