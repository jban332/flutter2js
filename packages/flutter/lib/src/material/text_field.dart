...
class TextField extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new IntProperty('maxLength', maxLength, defaultValue: null));
    description.add(new FlagProperty('maxLengthEnforced',
...
class _TextFieldState extends AutomaticKeepAliveClientMixin<TextField> {
  ...
  InputDecoration _getEffectiveDecoration() {
    if (!needsCounter) return widget.decoration;
  ...
  InteractiveInkFeature _createInkFeature(TapDownDetails details) {
    ...
    final RenderBox referenceBox =
        InputDecorator.containerOf(_editableTextKey.currentContext);
