...
class _CheckboxState extends TickerProviderStateMixin<Checkbox> {
  @override
...
class _RenderCheckbox extends RenderToggleable {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Paint paint = new Paint()..color = borderColor;
    ...
    if (t <= 0.5) {
      // Outline
      final RRect inner =
          outer.deflate(math.min(rectSize / 2.0, _kStrokeWidth + rectSize * t));
