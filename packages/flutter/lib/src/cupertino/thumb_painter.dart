...
final MaskFilter _kShadowMaskFilter =
    new MaskFilter.blur(BlurStyle.normal, BoxShadow.convertRadiusToSigma(1.0));
...
class CupertinoThumbPainter {
  ...
  void paint(Canvas canvas, Rect rect) {
    final RRect rrect = new RRect.fromRectAndRadius(
        rect, new Radius.circular(rect.shortestSide / 2.0));
