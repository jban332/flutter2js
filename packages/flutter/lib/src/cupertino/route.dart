...
class _CupertinoBackGestureDetectorState
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    _backGestureController
        .dragUpdate(details.primaryDelta / context.size.width);
  }
  ...
  void _handleDragEnd(DragEndDetails details) {
    ...
    assert(_backGestureController != null);
    _backGestureController
        .dragEnd(details.velocity.pixelsPerSecond.dx / context.size.width);
    _backGestureController = null;
  }
...
class _CupertinoEdgeShadowDecoration extends Decoration {
  ...
  static _CupertinoEdgeShadowDecoration lerp(_CupertinoEdgeShadowDecoration a,
      _CupertinoEdgeShadowDecoration b, double t) {
  ...
  bool operator ==(dynamic other) {
    ...
    if (other.runtimeType != _CupertinoEdgeShadowDecoration) return false;
