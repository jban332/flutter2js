...
class _CupertinoSwitchState extends TickerProviderStateMixin<CupertinoSwitch> {
  @override
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Paint paint = new Paint()..color = trackColor;
    ...
    final Rect trackRect = new Rect.fromLTWH(
        ...
        _kTrackWidth,
        _kTrackHeight);
    final RRect outerRRect = new RRect.fromRectAndRadius(
        trackRect, const Radius.circular(_kTrackRadius));
    final RRect innerRRect = new RRect.fromRectAndRadius(
