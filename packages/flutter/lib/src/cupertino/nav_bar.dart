  ...
  Widget build(BuildContext context) {
    ...
    if (styledLeading == null && automaticallyImplyLeading) {
      ...
      if (currentRoute?.canPop == true) {
        useBackButton = !(currentRoute is PageRoute &&
            currentRoute?.fullscreenDialog == true);
...
class _CupertinoLargeTitleNavigationBarSliverDelegate
  ...
  @override
  bool shouldRebuild(
      _CupertinoLargeTitleNavigationBarSliverDelegate oldDelegate) {
