...
abstract class FractionalOffsetGeometry {
  ...
  /// representing a combination of both is returned. That object can be turned
  /// into a concrete [FractionalOffset] using [resolve].
  static FractionalOffsetGeometry lerp(FractionalOffsetGeometry a,
      FractionalOffsetGeometry b, double t) {
    if (a == null && b == null) return null;
    if ((a == null || a is FractionalOffset) &&
        (b == null || b is FractionalOffset))
  ...
  bool operator ==(dynamic other) {
    if (other is! FractionalOffsetGeometry) return false;
...
class FractionalOffset extends FractionalOffsetGeometry {
  ...
  @override
  FractionalOffsetGeometry subtract(FractionalOffsetGeometry other) {
    if (other is FractionalOffset) return this - other;
  ...
  FractionalOffset operator ~/(double other) {
    return new FractionalOffset(
        (dx ~/ other).toDouble(), (dy ~/ other).toDouble());
  }
  ...
  static FractionalOffset lerp(FractionalOffset a, FractionalOffset b,
      double t) {
    if (a == null && b == null) return null;
    if (a == null)
      return new FractionalOffset(
  ...
  static String _stringify(double dx, double dy) {
    if (dx == 0.0 && dy == 0.0) return 'FractionalOffset.topLeft';
    if (dx == 0.5 && dy == 0.0) return 'FractionalOffset.topCenter';
    if (dx == 1.0 && dy == 0.0) return 'FractionalOffset.topRight';
    if (dx == 0.0 && dy == 0.5) return 'FractionalOffset.centerLeft';
    if (dx == 0.5 && dy == 0.5) return 'FractionalOffset.center';
    if (dx == 1.0 && dy == 0.5) return 'FractionalOffset.centerRight';
    if (dx == 0.0 && dy == 1.0) return 'FractionalOffset.bottomLeft';
    if (dx == 0.5 && dy == 1.0) return 'FractionalOffset.bottomCenter';
    if (dx == 1.0 && dy == 1.0) return 'FractionalOffset.bottomRight';
...
class FractionalOffsetDirectional extends FractionalOffsetGeometry {
  ...
  static const FractionalOffsetDirectional topStart =
  const FractionalOffsetDirectional(0.0, 0.0);

  /// The center point along the top edge.
  ///
  /// Consider using [FractionalOffset.topCenter] instead, as it does not need
  /// to be [resolve]d to be used.
  static const FractionalOffsetDirectional topCenter =
  const FractionalOffsetDirectional(0.5, 0.0);

  /// The top corner on the "end" side.
  static const FractionalOffsetDirectional topEnd =
  const FractionalOffsetDirectional(1.0, 0.0);

  /// The center point along the "start" edge.
  static const FractionalOffsetDirectional centerStart =
  const FractionalOffsetDirectional(0.0, 0.5);

  /// The center point, both horizontally and vertically.
  ///
  /// Consider using [FractionalOffset.center] instead, as it does not need to
  /// be [resolve]d to be used.
  static const FractionalOffsetDirectional center =
  const FractionalOffsetDirectional(0.5, 0.5);

  /// The center point along the "end" edge.
  static const FractionalOffsetDirectional centerEnd =
  const FractionalOffsetDirectional(1.0, 0.5);

  /// The bottom corner on the "start" side.
  static const FractionalOffsetDirectional bottomStart =
  const FractionalOffsetDirectional(0.0, 1.0);

  /// The center point along the bottom edge.
  ///
  /// Consider using [FractionalOffset.bottomCenter] instead, as it does not
  /// need to be [resolve]d to be used.
  static const FractionalOffsetDirectional bottomCenter =
  const FractionalOffsetDirectional(0.5, 1.0);

  /// The bottom corner on the "end" side.
  static const FractionalOffsetDirectional bottomEnd =
  const FractionalOffsetDirectional(1.0, 1.0);

  @override
  FractionalOffsetGeometry subtract(FractionalOffsetGeometry other) {
    if (other is FractionalOffsetDirectional) return this - other;
    return super.subtract(other);
  }
  ...
  @override
  FractionalOffsetDirectional operator ~/(double other) {
    return new FractionalOffsetDirectional(
        (start ~/ other).toDouble(), (dy ~/ other).toDouble());
  }
  ...
  ///
  /// If either is null, this function interpolates from [FractionalOffset.center].
  static FractionalOffsetDirectional lerp(FractionalOffsetDirectional a,
      FractionalOffsetDirectional b, double t) {
    if (a == null && b == null) return null;
    if (a == null)
      return new FractionalOffsetDirectional(
          ui.lerpDouble(0.5, b.start, t), ui.lerpDouble(0.5, b.dy, t));
    if (b == null)
      return new FractionalOffsetDirectional(
          ui.lerpDouble(a.start, 0.5, t), ui.lerpDouble(a.dy, 0.5, t));
    return new FractionalOffsetDirectional(
        ui.lerpDouble(a.start, b.start, t), ui.lerpDouble(a.dy, b.dy, t));
  }
  ...
  String toString() {
    ...
    if (start == 1.0 && dy == 0.0) return 'FractionalOffsetDirectional.topEnd';
    if (start == 0.0 && dy == 0.5)
