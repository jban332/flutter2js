...
class TextStyle extends Diagnosticable {
  ...
  RenderComparison compareTo(TextStyle other) {
    ...
    if (inherit != other.inherit ||
        ...
        wordSpacing != other.wordSpacing ||
        textBaseline != other.textBaseline ||
        height != other.height) return RenderComparison.layout;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties,
    ...
    styles.add(new DiagnosticsProperty<Color>('${prefix}color', color,
        defaultValue: null));
    styles.add(new StringProperty('${prefix}family', fontFamily,
        defaultValue: null, quoted: false));
    styles
        .add(new DoubleProperty('${prefix}size', fontSize, defaultValue: null));
    ...
    styles.add(new EnumProperty<FontStyle>('${prefix}style', fontStyle,
        defaultValue: null));
    styles.add(new DoubleProperty('${prefix}letterSpacing', letterSpacing,
        defaultValue: null));
    styles.add(new DoubleProperty('${prefix}wordSpacing', wordSpacing,
        defaultValue: null));
    styles.add(new EnumProperty<TextBaseline>('${prefix}baseline', textBaseline,
        defaultValue: null));
    styles.add(new DoubleProperty('${prefix}height', height,
    ...
    if (decoration != null ||
      ...
      styles.add(new DiagnosticsProperty<Color>(
      ...
      styles.add(new MessageProperty(
