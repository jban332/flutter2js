...
class FlutterLogoDecoration extends Decoration {
  ...
  FlutterLogoDecoration lerpFrom(Decoration a, double t) {
    ...
    if (a is! FlutterLogoDecoration) return lerp(null, this, t);
  ...
  FlutterLogoDecoration lerpTo(Decoration b, double t) {
    assert(debugAssertIsValid());
    if (b is! FlutterLogoDecoration) return lerp(this, null, t);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (_inTransition)
      properties
          .add(new DiagnosticsNode.message('transition $_position:$_opacity'));
  }
}
...
class _FlutterLogoPainter extends BoxPainter {
  ...
  void _paintLogo(Canvas canvas, Rect rect) {
    ...
    final Paint mediumPaint = new Paint()..color = _config.lightColor;
    final Paint darkPaint = new Paint()..color = _config.darkColor;
