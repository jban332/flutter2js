...
import 'package:flutter2js/core.dart' as flutter2js;
...
TargetPlatform get defaultTargetPlatform {
  ...
  final deviceInfo = flutter2js.DeviceInfo.current;
  switch (deviceInfo.operatingSystemType) {
    case flutter2js.OperatingSystemType.ios:
      return TargetPlatform.iOS;
    case flutter2js.OperatingSystemType.fuchsia:
