...
abstract class BindingBase {
  ...
  void initServiceExtensions() {
    assert(!_debugServiceExtensionsRegistered);
    registerSignalServiceExtension(
        name: 'reassemble', callback: reassembleApplication);
    registerSignalServiceExtension(name: 'exit', callback: _exitApplication);
    registerSignalServiceExtension(
        name: 'frameworkPresent', callback: () => new Future<Null>.value());
    assert(() {
...
Future<Null> _exitApplication() async {
  throw new UnsupportedError("Exiting application is not supported.");
}
