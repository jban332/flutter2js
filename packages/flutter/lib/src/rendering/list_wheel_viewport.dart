...
class RenderListWheelViewport
    extends RenderBoxContainerRenderObjectMixin<RenderBox, ListWheelParentData>
  ...
  double computeMinIntrinsicHeight(double width) {
    if (childCount > 0) return childCount * _itemExtent;
    return 0.0;
  }
  ...
  bool _shouldClipAtCurrentOffset() {
    ...
    return highestUntransformedPaintY < 0.0 ||
        size.height <
            highestUntransformedPaintY + _maxScrollExtent + _itemExtent;
  }
