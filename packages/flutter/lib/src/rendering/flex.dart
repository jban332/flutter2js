...
class RenderFlex
  ...
  void performLayout() {
    ...
    double allocatedSize =
        0.0; // Sum of the sizes of the the non-flexible children.
    RenderBox child = firstChild;
      ...
      switch (_direction) {
        case Axis.horizontal:
          childParentData.offset =
              new Offset(childMainPosition, childCrossPosition);
          break;
        case Axis.vertical:
          childParentData.offset =
              new Offset(childCrossPosition, childMainPosition);
          break;
      }
      if (flipMainAxis) {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    assert(() {
      ...
      switch (_direction) {
        case Axis.horizontal:
          overflowChildRect =
              new Rect.fromLTWH(0.0, 0.0, size.width + _overflow, 0.0);
          break;
        case Axis.vertical:
          overflowChildRect =
              new Rect.fromLTWH(0.0, 0.0, 0.0, size.height + _overflow);
          break;
      }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(new EnumProperty<MainAxisSize>('mainAxisSize', mainAxisSize));
