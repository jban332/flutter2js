...
typedef void SelectionChangedHandler(TextSelection selection,
...
class RenderEditable extends RenderBox {
  ...
  void _handleMoveCursorForwardByCharacter(bool extentSelection) {
    ...
    onSelectionChanged(
      new TextSelection(baseOffset: baseOffset, extentOffset: extentOffset),
      this,
  ...
  List<TextSelectionPoint> getEndpointsForSelection(TextSelection selection) {
    ...
    if (selection.isCollapsed) {
      ...
      final Offset start =
          new Offset(0.0, preferredLineHeight) + caretOffset + paintOffset;
  ...
  Rect getLocalRectForCaret(TextPosition caretPosition) {
    ...
    return new Rect.fromLTWH(0.0, 0.0, _kCaretWidth, preferredLineHeight)
  ...
  void handleLongPress() {
    ...
    if (onSelectionChanged != null) {
      final TextPosition position = _textPainter
          .getPositionForOffset(globalToLocal(_lastTapDownPosition));
      onSelectionChanged(
          _selectWordAtOffset(position), this, SelectionChangedCause.longPress);
    }
  }
