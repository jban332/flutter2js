...
abstract class DebugOverflowIndicatorMixin extends RenderObject {
  ...
  static final Paint _labelBackgroundPaint = new Paint()
  ...
  void paintOverflowIndicator(
    ...
    final RelativeRect overflow =
        new RelativeRect.fromRect(containerRect, childRect);
    ...
    for (_OverflowRegionData region in overflowRegions) {
      ...
      final Offset centerOffset =
          new Offset(-_indicatorLabel[region.side.index].width / 2.0, 0.0);
...
abstract class DebugOverflowIndicatorMixinHelper
    implements DebugOverflowIndicatorMixin {
  // This class is intended to be used as a mixin, and should not be
  // extended directly.
  factory DebugOverflowIndicatorMixinHelper._() => null;
