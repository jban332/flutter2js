...
class RenderView extends RenderObject
    ...
    if (configuration.orientation != _orientation) {
      if (_orientation != null && child != null)
        child.rotate(
            ...
            newAngle: configuration.orientation,
      ...
      assert(() {
        if (debugRepaintRainbowEnabled || debugRepaintTextRainbowEnabled)
          debugCurrentRepaintColor = debugCurrentRepaintColor
              .withHue(debugCurrentRepaintColor.hue + 2.0);
        return true;
      }());
    } finally {
      Timeline.finishSync();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(new DiagnosticsProperty<Size>(
    ...
    description.add(new DiagnosticsProperty<ViewConfiguration>(
