...
class RenderImage extends RenderBox {
  ...
  void _updateColorFilter() {
    if (_color == null)
      ...
      _colorFilter =
          new ColorFilter.mode(_color, _colorBlendMode ?? BlendMode.srcIn);
  }
  ...
  double computeMinIntrinsicWidth(double height) {
    ...
    return _sizeForConstraints(
            new BoxConstraints.tightForFinite(height: height))
        .width;
  }
  ...
  double computeMinIntrinsicHeight(double width) {
    assert(width >= 0.0);
    if (_width == null && _height == null) return 0.0;
    return _sizeForConstraints(new BoxConstraints.tightForFinite(width: width))
        .height;
  }
