    ...
    switch (axisDirection) {
      case AxisDirection.right:
        final BoxConstraints innerConstraints =
            new BoxConstraints.tightFor(height: constraints.maxHeight);
        while (child != null) {
        ...
        size = constraints
            .constrain(new Size(mainAxisExtent, constraints.maxHeight));
        break;
      ...
      case AxisDirection.down:
        ...
        size = constraints
            .constrain(new Size(constraints.maxWidth, mainAxisExtent));
        break;
