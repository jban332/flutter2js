...
abstract class UIPlugin {
  ...
  Widget buildClipOval(BuildContext context, ClipOval widget) => widget.child;

  Widget buildClipPath(BuildContext context, ClipPath widget) {
    throw new UnimplementedError();
  }

  Widget buildClipRect(BuildContext context, ClipRect widget) => widget.child;

  Widget buildClipRRect(BuildContext context, ClipRRect widget) => widget.child;
